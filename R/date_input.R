...
#' @param width Width
#' @param readonly If TRUE (default), the date can only be picked from the
#'   calendar popup; set to FALSE to also let the user type the date directly
#'   in the format given by `dateFormat`
#' @param dateFormat Display (and typing) format for the date, using
